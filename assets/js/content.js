...
export const principles = [
  ...
  {
    title: '초록불이라고 넘어가지 않는다',
    body: '핵심 코드를 지웠는데도 테스트 315개가 전부 통과한 적이 있다. 241개가 다 통과하는데 앱은 기동조차 못 한 적도 있다. 그래서 초록불을 보면 이 테스트가 정확히 무엇을 지키고 있는지부터 확인한다.',
  },
  {
    title: '조용히 실패하게 두지 않는다',
    body: '폴백이 정상 응답과 구분되지 않으면 버그가 품질 문제로 위장된다. 배포 환경에 바이너리가 없어 기능 하나가 소리 없이 꺼져 있던 적도 있다. 부가 기능의 실패가 핵심 API를 죽이지 않게 경계를 나누고, 폴백은 폴백임이 드러나게 만든다.',
  },
  {
